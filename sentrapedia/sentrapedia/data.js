// ═══════════════════════════════════════════════════════════════════════════════
// SENTRAPEDIA — Data 144 Penyakit Puskesmas Indonesia
// Berdasarkan Permenkes No. 5/2014 & SK Menkes 1186/2022
// Referensi: WHO, IDSA, PERKI, PERKENI, PAPDI, POI, PERDOSKI, Kemenkes RI
// ═══════════════════════════════════════════════════════════════════════════════

const DISEASES = [
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 1: GANGGUAN SALURAN PERNAFASAN ATAS (ISPA)
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 1,
  ...
  },
  {
    ...
    diagnosis:
      'Pemeriksaan faring: eritema, eksudat. Rapid Antigen Detection Test (RADT) untuk GAS jika skor Centor 3-4. Skor Centor: demam >38°C (1), tonsil eksudat (1), tidak ada batuk (1), limfadenopati servikal (1), usia 3-14 (1), usia >45 (-1).',
    terapi:
    ...
    rujukan:
      'Abses peritonsilar, obstruksi jalan napas, demam >39°C persisten >3 hari, tidak responsif terhadap antibiotik 48 jam, riwayat glomerulonefritis/rheumatic fever.',
  },
  {
    id: 3,
    nama: 'Sinusitis Akut',
    ...
    kode: 'J01',
    definisi:
      'Inflamasi akut mukosa sinus paranasal yang umumnya terjadi sebagai komplikasi dari common cold. Virus menyebabkan 90-98% kasus sinusitis akut. Dikategorikan sebagai sinusitis viral (≤10 hari), akut bakteri post-viral (>10 hari), atau fulminan bakteri (≥39°C + purulen sekret ≥3-4 hari berturut).',
    gejala: [
    ...
    diagnosis:
      "Kriteria sinusitis bakteri: durasi >10 hari tanpa perbaikan, gejala parah ≥39°C + purulen sekret/nanah ≥3-4 hari, atau 'double-worsening' (membaik lalu memburuk). CT scan sinus diperlukan hanya untuk diagnosis komplikasi atau sinusitis kronik.",
    terapi:
  ...
  },
  {
    ...
    diagnosis:
      'Otoscopy: membran timpani meneral (bulging), eritema, hilangnya landmark timpani, mobilitas berkurang. Pneumatic otoscopy adalah gold standard. Skor Kriteria AAP: otalgia berat 2 poin, otalgia ringan 1 poin, demam ≥39°C 2 poin, demam <39°C 1 poin. Skor ≥3 pertimbangkan antibiotik. Timpanometri bila diperlukan.',
    terapi:
  ...
  },
  {
    ...
    gejala: [
      'Onset akut demam tinggi (38-40°C)',
  ...
  },
  {
    ...
    diagnosis:
      'Pemeriksaan orofaring: tonsil bengkak dengan eksudat putih-kuning, eritema faring. Skor McIsaac (modifikasi Centor): demam >38°C (1), tonsil eksudat (1), tender anterior cervical node (1), onset <3 hari (1), usia 3-14 tahun (1), tidak ada batuk (1). Skor ≥4: probabilitas GAS tinggi. Rapid Strep Test bila tersedia.',
    terapi:
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 2: GANGGUAN SALURAN PERNAFASAN BAWAH
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 13,
    nama: 'Bronkitis Akut',
    ...
    rujukan:
      'Dispnea progresif, hemoptisis, demam >38.5°C >3 hari, riwayat TB, imunokompromais, symptom persisten >3 minggu, usia >65 dengan komorbid.',
  },
  {
    id: 14,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 3: GANGGUAN SALURAN CERNA
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 23,
  ...
  },
  {
    ...
    rujukan:
      'Disentri berat dengan dehidrasi, demam >39°C persisten, hematemesis, abdomen akut, sepsis, toxic megacolon (terutama pada EHEC — hindari antibiotik), usia <1 tahun, imunokompromais.',
  },
  {
    id: 29,
    nama: 'Hepatitis A',
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 4: PENYAKIT KULIT DAN JARINGAN SUBKUTAN
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 35,
  ...
  },
  {
    ...
    rujukan:
      'Tinea pedis moccasin/extensive, tidak responsif topikal, onikomikosis bersamaan, imunokompromais, komplikasi (selulitis — Streptococcus β-hemolytic), diabetes dengan infeksi.',
  },
  {
    id: 41,
    nama: 'Onikomikosis',
  ...
  },
  {
    ...
    diagnosis:
      'Diagnosis klinis: eritema akut, hangat, edema, nyeri. Marking batas eritema untuk monitor progresi. Kultur: dari aspirasi/punch biopsy bila ada abses/pustul; blood culture bila demam >38.5°C. WBC dan CRP meningkat. Perlu dibedakan dengan erisipelas (batas jelas, raised), DVT, alergi kontak, gout.',
    terapi:
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 5: PENYAKIT TIDAK MENULAR (PTM) — KARDIOVASKULAR
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 49,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 6: PENYAKIT TIDAK MENULAR (PTM) — METABOLIK
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 61,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 7: PENYAKIT TROPIS & INFEKSI MENULAR
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 69,
    nama: 'Malaria',
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 8: GANGGUAN NEUROLOGIS
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 81,
    nama: 'Migrain',
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 9: GANGGUAN JIWA & PERILAKU
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 88,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 11: GANGGUAN MUSKULOSKELETAL
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 101,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 12: GINJAL & SALURAN KEMIH
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 106,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 13: GIZI & TUMBUH KEMBANG
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 110,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 14: KESEHATAN REPRODUKSI
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 112,
  ...
  // ═════════════════════════════════════════════════════════════════════════════
  // KATEGORI 15: PENYAKIT TROPIS — LANJUTAN
  // ═════════════════════════════════════════════════════════════════════════════
  {
    id: 115,
    nama: 'Frambusia (Yaws)',
